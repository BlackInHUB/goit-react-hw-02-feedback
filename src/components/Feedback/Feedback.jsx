...
export const Feedback = ({ values, onClick }) => {
    ...
    return (
        ...
        <BtnsList>
                {keys.map(key =>
                (<BtnsListItem key={key}>
                    <Btn type='button' name={key} onClick={onClick}>{keyToUpeerCase(key)}
                    </Btn>
                </BtnsListItem>))}
        </BtnsList>
        ...
        <StatList>
                ...
                (<StatListItem key={key}>
                    <StatListItemText>{keyToUpeerCase(key)}: {values[key]}</StatListItemText>
                </StatListItem>))}
        </StatList>
        </Box>
    )
